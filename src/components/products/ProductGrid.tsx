...
const ProductGrid: React.FC = () => {
  const products = [
    ...
    },
    {
      ...
      description: 'Affordable RPA solution for small to medium businesses looking to automate workflows.',
      price: 4999,
      originalPrice: 6999,
      rating: 4.5,
      reviews: 210,
      ...
      bgColor: 'bg-blue-50',
      features: ['Workflow Automation', 'Process Mining', 'Email Support', 'Training Resources'],
      icon: FireOutlined,
      popular: false,
    },
    {
      ...
      description: 'Enhanced IoT platform with premium features for manufacturing and production monitoring.',
      price: 12999,
      originalPrice: 16999,
      rating: 4.7,
      reviews: 156,
      ...
      features: ['Production Monitoring', 'Quality Control', 'Predictive Maintenance', 'Custom Dashboards'],
      icon: TrophyOutlined,
      popular: true,
    },
    {
      id: 6,
      name: 'Collaborative Robot System',
      description: 'Perfect for teams that need safe human-robot collaboration in manufacturing environments.',
      price: 8999,
      originalPrice: 11999,
      rating: 4.6,
      reviews: 98,
      ...
      bgColor: 'bg-green-50',
      features: ['Safety Systems', 'Easy Programming', 'Multi-Robot Coordination', 'Remote Monitoring'],
      icon: RocketOutlined,
      popular: false,
    },
  ];
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            <span className="text-gradient-primary">Advanced Robotics</span>
            <br />
            <span className="text-gradient-accent">& IoT Solutions</span>
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Discover our comprehensive range of robotics and IoT products with seamless application integration designed to automate processes and drive digital transformation.
          </p>
        </div>
          ...
          {products.map((product, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Product Header */}
                <div className={`relative p-8 bg-gradient-to-br ${product.gradient} text-white min-h-[200px] flex flex-col justify-between`}>
